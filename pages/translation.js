        ...
        <>
            ...
            <Layout>
                <main className="pt-16 h-screen grid grid-flow-row xl:grid-cols-4 xl:pl-48 xl:pt-0">
                    <section className="p-6 bg-first-50 border-b-2 border-first-300 dark:bg-first-700 dark:border-first-900 xl:border-b-0 xl:border-r-2 xl:col-start-1 xl:col-end-2">
                    ...
                    <section className="p-6 bg-first-50 dark:bg-first-700 xl:col-start-2 xl:col-end-5">
                                ...
                                <div className="relative bg-first-200 border-2 border-first-400 p-3 rounded divide-y-2 divide-first-400 dark:bg-first-800 dark:border-first-900 dark:divide-first-900">
                                    ...
                                    <div className="absolute bottom-0 left-0 w-full p-2">
                                        <div className="grid grid-flow-col gap-4 justify-items-stretch">
                                            <a href={project.source} className="p-1 rounded text-first-800 text-base text-center font-semibold border-2 border-first-400 hover:bg-first-300 dark:text-first-50 dark:border-first-900 dark:hover:bg-first-900" target="_blank">Source</a>
                                            <a href={project.translation} className="p-1 rounded text-first-800 text-base text-center font-semibold border-2 border-first-400 hover:bg-first-300 dark:text-first-50 dark:border-first-900 dark:hover:bg-first-900" target="_blank">Translation</a>
                                            {project.pr ? <a href={project.pr} className="p-1 rounded text-first-800 text-base text-center font-semibold border-2 border-first-400 hover:bg-first-300 dark:text-first-50 dark:border-first-900 dark:hover:bg-first-900" target="_blank">Context</a> : null}
                                        </div>
                                    </div>
                                </div>
                            ))}
