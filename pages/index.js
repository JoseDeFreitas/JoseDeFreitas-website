                    ...
                    <section className="relative col-start-1 col-end-2 p-12 bg-first-50 border-r-2 border-first-200">
                        ...
                        <div className="absolute bg-first-100 bottom-0 left-0 w-full p-4 border-t-2 border-first-200">
                            <div className="grid grid-flow-col gap-4 justify-items-stretch">
                                <a href="https://github.com/JoseDeFreitas" className="p-2 rounded text-first-800 text-base text-center font-semibold border-2 border-first-300 hover:bg-gray-200" target="_blank">GitHub</a>
                                <a href="https://crowdin.com/profile/JoseDeFreitas" className="p-2 rounded text-first-800 text-base text-center font-semibold border-2 border-first-300 hover:bg-green-200" target="_blank">Crowdin</a>
                                <a href="https://twitter.com/JoseDeF32503298" className="p-2 rounded text-first-800 text-base text-center font-semibold border-2 border-first-300 hover:bg-blue-200" target="_blank">Twitter</a>
                            </div>
                        </div>
                    </section>
